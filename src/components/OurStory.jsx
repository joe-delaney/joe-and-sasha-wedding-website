            ...
            <div className="our-story flex flex-col gap-8 justify-items-center bg-light-blue-100">
                ...
                <div className="text-l text-light-blue-500 flex flex-col gap-3">
                    <div className="our-story-section">
                        ...
                        <img src={formalImg} className="our-story-img" alt="our story 1"></img>
                    </div>
                    <div className="our-story-section">
                        <img src={italyImg} className="our-story-img" alt="our story 2"></img>
                    ...
                    <div className="our-story-section">
                        ...
                        <img src={familyImg} className="our-story-img" alt="our story 3"></img>
                    </div>
                </div>
            </div>
